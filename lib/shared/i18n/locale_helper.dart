...
Map<String, String> _labels = {
  ...
  'site_popkontv': 'PopkonTV',
  'site_shopeelive': 'Shopee Live',
  'site_vkvideolive': 'VK Video Live',
  'site_nimotv': 'NimoTV',
  ...
  'taobaolive_chat_notice': '淘宝远端聊天尚待接入；viewCount 按场次累计观看展示，不作为当前并发人数，主播粉丝数单独展示。',
  'kugoulive_chat_notice': '酷狗远端聊天尚待接入；viewerNum/getViewerNum 按当前观看人数展示，hot 按平台热度展示，fansCount 单独作为粉丝数。',
  'baidulive_chat_notice': '百度远端聊天尚待接入；目录 audience_count 与房间 online_users 按当前观看人数展示，粉丝数单独保留。',
  'zhanqi_chat_notice': '战旗远端聊天尚待接入；房间公开在线人数单独展示。',
  'pandalive_chat_notice': 'PandaTV 远端聊天尚待接入；user 字段按平台当前在线人数展示，playCnt 不作为并发人数。',
  'popkontv_chat_notice': 'PopkonTV 远端聊天尚待接入；watchCnt 按当前在线人数展示，totalWatchCnt 作为本场累计观看单独保留。',
  'shopeelive_chat_notice': 'Shopee Live 远端聊天尚待接入；目录 view_count 与详情 viewer_count 按当前观看人数展示，member_cnt 不作为并发人数。',
  ...
  'update_error_no_url': '没有可用的下载地址',
  'update_error_storage': '无法创建下载目录',
  'update_error_package_missing': '安装包不存在，请重新下载',
  'update_error_install_permission': '未授予“安装未知应用”权限',
  'update_error_installer_launch': '无法启动安装程序',
  'update_error_package_empty': '下载的安装包为空，请重试',
  'update_error_package_invalid': '下载的安装包不完整或已损坏，请重试',
  'update_error_package_size': '安装包大小校验失败（期望 {expected}，实际 {actual}）',
  'update_error_http_status': '下载失败（HTTP {code}）',
  'update_error_timeout': '下载超时，请重试',
  'update_error_network': '网络连接失败，请重试',
  'update_renderer': '渲染器',
