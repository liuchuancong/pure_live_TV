...
import 'package:pure_live/core/sites/twitch/twitch_models.dart';
import 'package:pure_live/core/sites/danmaku/twitch_danmaku.dart';
import 'package:pure_live/core/sites/interface/live_danmaku.dart';
import 'package:pure_live/core/sites/scripts/live_quality_label.dart';
import 'package:pure_live/core/utils/twitch/twitch_web_integrity.dart';
import 'package:pure_live/core/sites/scripts/android_native_http.dart';
import 'package:pure_live/core/sites/interface/site_capabilities.dart';
import 'package:pure_live/core/sites/twitch/twitch_web_integrity.dart';
...
class TwitchSite implements LiveSite, LiveSiteRoomRefresher, LiveSiteRecordRoomResolver {
  ...
  void getRequestHeaders() {
    ...
    final cookie = SettingsService.to.cookieManagerState.twitchCookie.trim();
