...
class KuaishouCookieController extends GetxController {
  ...
  void initServer() async {
    ...
    fullServerUrl.value = "http://$primaryIp:8082";
  ...
  String _buildWebHtml() {
    ...
    <head>
      ...
      <title>PureLive 快手Cookie设置</title>
      <style>
    ...
    <body>
      <div class="card">
        <h2>发送至电视</h2>
        <p style="color: #666; font-size: 14px;">在下方粘贴快手cookie内容：</p>
        <textarea id="txt" placeholder="请输入快手cookie内容"></textarea>
