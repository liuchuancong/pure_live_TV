...
class _MoviePlaybackPageState extends ConsumerState<MoviePlaybackPage> {
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: hasServer ? Colors.green.withOpacity(0.1) : Colors.red.withOpacity(0.1),
  ...
  Widget _buildSupportInfo(TvThemeData currentTvTheme) {
    return Container(
      ...
      padding: EdgeInsets.all(20.sp),
      decoration: BoxDecoration(
        color: currentTvTheme.cardColor.withOpacity(0.5),
        borderRadius: BorderRadius.circular(16.sp),
        border: Border.all(color: currentTvTheme.cardColor.withOpacity(0.2)),
      ),
      child: Wrap(
        spacing: 16.sp,
        runSpacing: 8.sp,
            ...
            .map(
              (e) => Text(
                ...
                style: AppTextStyles.t18W600.copyWith(
                  color: currentTvTheme.secondaryTextColor.withOpacity(0.5),
                  fontSize: 25.sp,
                  fontWeight: FontWeight.bold,
                ),
              ),
