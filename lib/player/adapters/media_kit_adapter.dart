  ...
  Future<void> init() async {
    ...
    try {
      ...
      if (_player.platform is NativePlayer) {
        ...
        if (SettingsService.to.playerState.customPlayerOutput) {
          await native.setProperty('ao', SettingsService.to.playerState.audioOutputDriver);
        }
      }
      ...
      _controller = SettingsService.to.playerState.playerCompatMode
          ? VideoController(
              _player,
          ...
          ? VideoController(
              ...
              configuration: VideoControllerConfiguration(
                vo: SettingsService.to.playerState.videoOutputDriver,
                hwdec: SettingsService.to.playerState.videoHardwareDecoder,
              ),
            )
          : VideoController(
              _player,
              configuration: VideoControllerConfiguration(
                enableHardwareAcceleration: SettingsService.to.playerState.enableCodec,
  ...
  Widget getVideoWidget() {
    return RepaintBoundary(
      child: Video(
        ...
        pauseUponEnteringBackgroundMode: !SettingsService.to.appState.enableBackgroundPlay,
        resumeUponEnteringForegroundMode: !SettingsService.to.appState.enableBackgroundPlay,
      ),
    );
  }
