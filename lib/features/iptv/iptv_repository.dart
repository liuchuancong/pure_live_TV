...
import 'package:pure_live/features/iptv/models/channel.dart' as models;
...
class IptvRepository {
  ...
  Future<List<models.IptvChannel>> getChannels(String providerId) async {
    try {
