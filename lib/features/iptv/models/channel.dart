...
class IptvProvider extends Equatable {
  final String id;
  final String name;
  ...
  final IptvProviderStatus status;
  ...
  const IptvProvider({
    ...
    this.lastRefresh,
    this.channelCount = 0,
    this.status = IptvProviderStatus.unknown,
  });
...
enum IptvProviderType { m3u, m3uPlus, xtreamCodes }

enum IptvProviderStatus { unknown, online, offline, error }
