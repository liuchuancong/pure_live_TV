...
import 'package:pure_live/features/iptv/data/database.dart' as db;
...
List<db.ChannelsCompanion> reconcilePlaylistChannels({
  ...
  required List<model.IptvChannel> incoming,
}) {
  final unique = <String, model.IptvChannel>{};
...
db.ChannelsCompanion _entry(String providerId, model.IptvChannel channel, db.Channel? old) {
