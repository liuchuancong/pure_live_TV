...
class $ChannelsTable extends Channels with TableInfo<$ChannelsTable, Channel> {
  ...
  static const VerificationMeta _catchupModeMeta = const VerificationMeta(
    'catchupMode',
  );
  @override
  ...
  static const VerificationMeta _catchupSourceMeta = const VerificationMeta(
    'catchupSource',
  );
  @override
  ...
  static const VerificationMeta _catchupCorrectionHoursMeta =
      const VerificationMeta('catchupCorrectionHours');
  @override
  late final GeneratedColumn<double> catchupCorrectionHours =
  ...
  static const VerificationMeta _httpHeadersJsonMeta = const VerificationMeta(
    'httpHeadersJson',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('catchup_mode')) {
      context.handle(
        _catchupModeMeta,
        catchupMode.isAcceptableOrUnknown(
          data['catchup_mode']!,
          _catchupModeMeta,
        ),
      );
    ...
    if (data.containsKey('catchup_correction_hours')) {
      context.handle(
        ...
        catchupCorrectionHours.isAcceptableOrUnknown(
          data['catchup_correction_hours']!,
          _catchupCorrectionHoursMeta,
        ),
      );
    }
    if (data.containsKey('http_headers_json')) {
      context.handle(
        ...
        httpHeadersJson.isAcceptableOrUnknown(
  ...
  Channel map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Channel(
      ...
      catchupMode: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}catchup_mode'],
      ),
      catchupSource: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}catchup_source'],
      ),
...
class Channel extends DataClass implements Insertable<Channel> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || catchupCorrectionHours != null) {
      map['catchup_correction_hours'] = Variable<double>(
        catchupCorrectionHours,
      );
    }
  ...
  factory Channel.fromJson(
    ...
    return Channel(
      ...
      catchupCorrectionHours: serializer.fromJson<double?>(
        json['catchupCorrectionHours'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'catchupCorrectionHours': serializer.toJson<double?>(
        catchupCorrectionHours,
      ),
  ...
  Channel copyWith({
    ...
    catchupSource: catchupSource.present
        ? catchupSource.value
        : this.catchupSource,
    catchupDays: catchupDays.present ? catchupDays.value : this.catchupDays,
    catchupCorrectionHours: catchupCorrectionHours.present
        ? catchupCorrectionHours.value
        : this.catchupCorrectionHours,
    httpHeadersJson: httpHeadersJson.present
  ...
  Channel copyWithCompanion(ChannelsCompanion data) {
    return Channel(
      ...
      streamType: data.streamType.present
          ...
          : this.streamType,
      catchupMode: data.catchupMode.present
          ? data.catchupMode.value
          : this.catchupMode,
      ...
      catchupCorrectionHours: data.catchupCorrectionHours.present
          ...
          : this.catchupCorrectionHours,
      httpHeadersJson: data.httpHeadersJson.present
          ? data.httpHeadersJson.value
          : this.httpHeadersJson,
...
class ChannelsCompanion extends UpdateCompanion<Channel> {
  ...
  static Insertable<Channel> custom({
    ...
    return RawValuesInsertable({
      ...
      if (catchupCorrectionHours != null)
        'catchup_correction_hours': catchupCorrectionHours,
  ...
  ChannelsCompanion copyWith({
    ...
    return ChannelsCompanion(
      ...
      catchupCorrectionHours:
          catchupCorrectionHours ?? this.catchupCorrectionHours,
...
class $$ChannelsTableFilterComposer
  ...
  ColumnFilters<String> get catchupMode => $composableBuilder(
    column: $table.catchupMode,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<double> get catchupDays => $composableBuilder(
    column: $table.catchupDays,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<double> get catchupCorrectionHours => $composableBuilder(
    column: $table.catchupCorrectionHours,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get httpHeadersJson => $composableBuilder(
    column: $table.httpHeadersJson,
    builder: (column) => ColumnFilters(column),
  );
...
class $$ChannelsTableOrderingComposer
  ...
  ColumnOrderings<String> get catchupMode => $composableBuilder(
    column: $table.catchupMode,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<double> get catchupDays => $composableBuilder(
    column: $table.catchupDays,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<double> get catchupCorrectionHours => $composableBuilder(
    column: $table.catchupCorrectionHours,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get httpHeadersJson => $composableBuilder(
    column: $table.httpHeadersJson,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$ChannelsTableAnnotationComposer
  ...
  GeneratedColumn<String> get catchupMode => $composableBuilder(
    column: $table.catchupMode,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<double> get catchupDays => $composableBuilder(
    column: $table.catchupDays,
    builder: (column) => column,
  );

  GeneratedColumn<double> get catchupCorrectionHours => $composableBuilder(
    column: $table.catchupCorrectionHours,
    builder: (column) => column,
  );

  GeneratedColumn<String> get httpHeadersJson => $composableBuilder(
    column: $table.httpHeadersJson,
    builder: (column) => column,
  );
