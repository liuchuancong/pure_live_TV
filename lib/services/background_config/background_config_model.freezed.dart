...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,source,boxFit,maskOpacity,blur,autoSwitch,autoSwitchIntervalHours,solidColor,const DeepCollectionEquality().hash(gradientColors),assetImagePath,localImagePath,networkImageUrl,currentBoxImageBase64,assetVideoPath,localVideoPath,networkVideoUrl);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,source,boxFit,maskOpacity,blur,autoSwitch,autoSwitchIntervalHours,solidColor,const DeepCollectionEquality().hash(_gradientColors),assetImagePath,localImagePath,networkImageUrl,currentBoxImageBase64,assetVideoPath,localVideoPath,networkVideoUrl);
