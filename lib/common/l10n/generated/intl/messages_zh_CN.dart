...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(String name) => "${name}未开始直播.";

  static String m1(String name) => "${name}轮播视频中.";

  static String m2(String version) => "发现新版本: v${version}";

  static String m3(String number) => "群号: ${number}";

  static String m4(String roomid, String platform, String nickname, String title, dynamic livestatus) =>
      "房间号: ${roomid}\n平台: ${platform}\n昵称: ${nickname}\n标题: ${title}\n状态: ${livestatus}";

  static String m5(String error) => "发生意外错误：${error}";

  static String m6(String time) => "${time} 分钟";

  static String m7(String name) => "确定要取消关注${name}吗？";
