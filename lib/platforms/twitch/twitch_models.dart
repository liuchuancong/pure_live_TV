class TwitchResponse {
  ...
  factory TwitchResponse.fromJson(Map<String, dynamic> json) {
    return TwitchResponse(data: Data.fromJson(json['data']));
  }
}
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      userOrError: json['userOrError'] != null ? UserOrError.fromJson(json['userOrError']) : null,
...
class Game {
  ...
  Game({required this.id, required this.name, required this.typename, required this.displayName});
...
class Channel {
  ...
  Channel({required this.id, required this.typename, this.selfEdge, this.trailer});

  factory Channel.fromJson(Map<String, dynamic> json) {
    return Channel(
      id: json['id'] ?? '',
      typename: json['__typename'] ?? '',
      selfEdge: json['self'] != null ? ChannelSelfEdge.fromJson(json['self']) : null,
...
class ChannelSelfEdge {
  ...
  ChannelSelfEdge({required this.isAuthorized, this.restrictionType, required this.typename});
...
class Trailer {
  ...
  Trailer({required this.typename});

  factory Trailer.fromJson(Map<String, dynamic> json) {
    return Trailer(typename: json['__typename'] ?? '');
  }
}
